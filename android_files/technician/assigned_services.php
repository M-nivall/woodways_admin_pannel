...
c2.first_name,c2.last_name FROM bookings o INNER JOIN assign a ON o.order_id = a.order_id
          RIGHT JOIN clients c2 on o.client_id = c2.client_id  WHERE o.order_status='6'AND a.emp_id='$staffID' ORDER BY o.order_id DESC";
  ...
  if(mysqli_num_rows($query)>0){
      ...
      while ($row=mysqli_fetch_array($query)){
          ...
          $temp['orderStatus'] = "Confirm After Service Completion";
      ...
      $results['status'] = "0";
      $results['message'] = "No services found";
