...
c2.first_name,c2.last_name FROM bookings o INNER JOIN service_payment p on o.order_id = p.order_id
          RIGHT JOIN clients c2 on o.client_id = c2.client_id WHERE o.order_status='6' ORDER BY o.order_id DESC";
