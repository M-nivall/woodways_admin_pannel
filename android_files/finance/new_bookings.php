...
$select = "SELECT o.order_id,o.order_status,o.order_date,o.county_id,o.town_id,o.address,o.payment_code,
          c2.first_name,c2.last_name,o.booking_fee_status 
          FROM bookings o
          RIGHT JOIN clients c2 on o.client_id = c2.client_id WHERE o.order_status='1' AND o.booking_fee_status = 'pending' ORDER BY o.order_id DESC";
  ...
  if(mysqli_num_rows($query)>0){
      ...
      while ($row=mysqli_fetch_array($query)){
          ...
          $temp['orderCost'] = '2,500';
          $temp['mpesaCode'] = $row['payment_code'];
          $temp['shippingCost'] = '2,500';
          $temp['itemCost'] = '2,500';
