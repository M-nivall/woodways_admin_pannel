...
//creating a query
$select = "SELECT p.id,p.supplier_id,p.amount,p.payment_description,p.payment_status,p.payment_date ,c.first_name,c.last_name FROM supply_payment p INNER JOIN  clients c on c.client_id = p.supplier_id WHERE p.payment_status='Paid'ORDER BY p.id DESC";
